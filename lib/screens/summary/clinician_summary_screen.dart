...
class ClinicianSummaryScreen extends StatefulWidget {
  const ClinicianSummaryScreen({super.key});
...
class _ClinicianSummaryScreenState extends State<ClinicianSummaryScreen> {
  bool loading = true;
  ...
  Future<void> loadRisk() async {
    try {
      ...
      setState(() {
        ...
        // Convert to standardized timelines
        memoryTimeline =
            RiskEngine.toZTimeline(memory, inverse: true);
        attentionTimeline =
            RiskEngine.toZTimeline(digit);
        executiveTimeline =
            RiskEngine.toZTimeline(trail);
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              ...
              "NeuroSense is currently learning your personal cognitive patterns. "
              "After a few more short activities, this page will show trend insights "
          ...
          const Text(
            "• Complete weekly cognitive activities\n"
            "• Scores are compared to your own baseline\n"
            "• Only meaningful changes are highlighted\n",
            style: TextStyle(fontSize: 16),
          ),
          ...
          Container(
            ...
            child: const Text(
              "This summary is intended to support clinical "
              "conversations and does not provide a diagnosis.",
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text("Generate Clinician PDF Report"),
              onPressed: () async {
          ...
          Container(
            ...
            child: const Text(
              "This summary is intended to support clinical "
              "conversations and does not provide a diagnosis. "
              "Further evaluation may be considered if concerns persist.",
              style: TextStyle(fontSize: 14),
            ),
          ),
        ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Clinician Summary")),
     body: loading
    ? const Center(child: CircularProgressIndicator())
    : SingleChildScrollView(
        child: riskLevel == "insufficient_data"
